...
class SearchVegan extends StatefulWidget {
  @override
  State<SearchVegan> createState() => _SearchVeganState();
}

class _SearchVeganState extends State<SearchVegan> {
