...
class SearchSnacks extends StatefulWidget {
  @override
  State<SearchSnacks> createState() => _SearchSnacksState();
}

class _SearchSnacksState extends State<SearchSnacks> {
